...
const CartItem = ({ item }) => {
  ...
  return (
    <div className="flex flex-col gap-6 bg-white p-6 rounded-xl shadow-sm hover:shadow-lg border border-gray-200 transition-all duration-300 hover:border-purple-200 md:flex-row md:items-center md:justify-between">
      ...
      <div className="flex items-center gap-2 bg-gray-100 rounded-lg p-2 md:mx-4">
        <button
          type="button"
      ...
      <div className="text-left min-w-max md:text-right md:mx-4">
      ...
      <button
        ...
        className="self-start text-red-500 hover:bg-red-50 p-3 rounded-lg transition-all duration-200 transform hover:scale-110 md:self-auto"
